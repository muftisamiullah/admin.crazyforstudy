...
router
  ...
  .get(
    "/bartelby-chapters/:isbn?/:status?",
    checkAuth,
    Chapter.BartelbyChapters
  )
  ...
  .get(
    "/bartelby-problems/:book_isbn?/:section_id?/:sub_section_id?",
    checkAuth,
    Chapter.BartelbyProblems
  )
  .get(
    "/bartelby-answers/:question_id?",
    checkAuth,
    Chapter.BartelbyQuestionAnswers
  )
  .post(
    "/bartelby-chapter-change-status",
    checkAuth,
    Chapter.BartelbyChaptersChangeStatus
  )
  .post(
    "/bartelby-update-chapter-answer",
    checkAuth,
    Chapter.BartelbyUpdateChaptersAnswer
  )
  ...
  .get(
    "/oldbook-questions/:isbn?/:chapter_no?",
    checkAuth,
    Chapter.oldbookQuestions
  )
  ...
  .get(
    "/qc-chapter-questions/:isbn/:chapter_no?/:status?",
    checkAuth,
    Chapter.GetQCChapterQuestions
  )
  ...
  .patch(
    "/upload-solution/:q_id",
    upload.single("file"),
    checkAuth,
    Chapter.UpdateSingleSolution
  )
  ...
  .get(
    "/exercise/:isbn/:chapter_no/:section_no",
    checkAuth,
    Chapter.getBookExercises
  )
  .get(
    "/problem/:isbn/:chapter_no/:section_no/:excerise_no",
    checkAuth,
    Chapter.getBookProblems
  )
  .get(
    "/only-problem/:isbn/:chapter_no",
    checkAuth,
    Chapter.getBookOnlyProblems
  )
  ...
  .get(
    "/get-all-quesions-tbs/:filter?/:pageno/:limit",
    checkAuth,
    Chapter.getAllQuestionsTbs
  )

...
function ReviewSubSubjectHeadingQA({review}) {
    ...
    const deleteMutation = useMutation(formData => {
        return axios.delete(`${API_URL}sub-subject/delete-review-qa/${params.id}/${formData.review_id}`, options)
    },{
        onSuccess: () => {
...
export default ReviewSubSubjectHeadingQA

...
export default function SeoBreadCrumbSubjectTB() {
    ...
    return (
        <div className="p-0">
            ...
            <button onClick={e => history.push(`/subject-content/textbook/update/${params.id}`)} className="btn btn-sm counter btn-warning pl-2 pr-2 ml-2">

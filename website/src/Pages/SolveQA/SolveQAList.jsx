...
export default function SolveQAList() {
    const history = useHistory();
    const params = useParams();
    const location = useLocation();
    const {state} = useContext(AuthContext);

    const {data, isLoading:isLoadingQestions, error} = useQA();
                        ...
                        <div className="dash-con-heading">
                            <div className="col-md-12 row">
                                ...
                                onChange={e => {
                                    ...
                                    if(subject === undefined){
                                        history.push(`/solve-qa`)
                                    }else{
                                        history.push(`/solve-qa/${subject_id}`)
                                    }
                                }}
                            >
                            ...
                            <select className="col-md-2 ml-2 form-control"
                                onChange={e => {
                                    ...
                                    if(sub_subject === undefined){
                                        ...
                                        history.push(`/solve-qa/${params.subject_id}/${sub_subject_id}`)
                                    }
                                }}
                            >
                            ...
                            <select className="col-md-2 ml-2 form-control"
                                onChange={e => {   
                                    ...
                                    if(filter != 999){
                                        history.push(`/solve-qa/${params.subject_id}/${params.sub_subject_id}/${filter}`)
                                    }
                                }}
                            >
